...
class ProfilResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\TextInput::make('site')->maxLength(255)->default(null),
            Forms\Components\TextInput::make('nature')->maxLength(255)->default(null),
            Forms\Components\TextInput::make('identifiant')->required()->maxLength(255),
        ]);
    }
