...
class ProfilResource extends Resource
{
    ...
    protected static ?string $navigationIcon = 'heroicon-o-shield-check'; // Icône adaptée

    protected static ?string $navigationGroup = 'Menu Administrateur'; // Groupe du menu
